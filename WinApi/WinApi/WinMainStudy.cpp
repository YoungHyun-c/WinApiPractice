...
/*
 ...
 - 움직임도 가능하고, 크기 또한 조절이 가능해야 함.
  ㄴ 마우스 왼 / 오 ->
  ㄴ 마우스로 움직이고 있는 사각형의 다른 사각형과 충돌되면 충돌된 사각형 "자연스럽게" 밀려난다.
   -> SetTimer가 필요할것.
 ...
 - 도형의 크기 + 도형의 모양 + 도형의 종류까지 모두 무작위로 설정.
 
 - 도형의 종류 : 사각형 / 원 / 삼각형 / 선택 : 다각형.

 - 삼각형 / 다각형 -> Polygon() 함수를 사용하면 된다.
 ...
 -> hdc를 반드시 사용해야 하고, Rectangle() 함수 꼭 사용해야 한다.
